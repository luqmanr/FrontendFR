<template>
    ...
    <div>
        <div class="photo-compare row">
            ...
            <div class="col-md-6 row">
                <span class="col-sm-12">user_id: (randomly generated)</span>
                <input type=text v-model.lazy="payloadData.user_id" class="col-sm-11" readonly="readonly">      
            </div>
            ...
            <div class="col-md-6 row"
                ...
                <!-- <b-collapse id="collapse-2" visible> -->
                    <span class="col-md-12">client_id: </span>
                    <select v-model.lazy="payloadData.region" class="col-md-12">
                ...
                <b-collapse id="collapse-2" class='col-sm-12'>
                    ...
                    <input type=text v-model.lazy="payloadData.region" class="col-sm-12"> 
                </b-collapse>
            </div>
        ...
        <div class="response-area">
            <div class="column">
                <p>
                    Raw Response: 
                    <li v-show="responseData.raw_data.length"
                        style='font-weight: bolder;
                               list-style-type: none;
                               font-size: larger;'>{{ responseData.raw_data }}</li>
                </p>
        ...
        <div class="upload-section">
            <button 
                v-if="payloadData.region == 0 || payloadData.name == 0"
...
export default {
    ...
    data() {
        return {
            apiInferencing: 'https://api.riset.ai/api_fr/v2/registerimage', // apiEndpoint untuk melakukan inferencing
    ...
    methods: {
        ...
        uploadImgInference() {
            ...
            var apiEndpoit = this.apiInferencing
                ...
                .then((data) => {
                  ...
                  try {
                    if (data.data.status == 0) {
                        this.responseData.raw_data = "SUCCESSFULLY REGISTERED"
                    }
                  } catch {
